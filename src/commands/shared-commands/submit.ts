...
export const args = {
  ...
  always: {
    describe:
      'Always push updates, even if the branch has not changed. Can be helpful for fixing an inconsistent Freephite stack view on Web/GitHub resulting from downtime/a bug.',
    type: 'boolean',
    default: false,
  },
  branch: {
